...
export default function AddConnection() {
    ...
    return (<form onSubmit={handleSubmit}>
        ...
        <FormControl style={formControlStyle}>
            ...
            <Input id="special_query" name="special_query" type="text" value={inputs.special_query} onChange={handleChange}/>
        </FormControl><br/>
        <Button variant="contained" sx={{
            backgroundColor: '#057D55', '&:hover': {color: 'white'}
        }} endIcon={<KeyboardArrowUpIcon/>} href="/special-queries" type="submit">Submit</Button>
    </form>)
