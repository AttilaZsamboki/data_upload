...
class DatauploadBevtelek(models.Model):
    ...
    # Field name made lowercase.
    osszesen_huf = models.FloatField(db_column="Osszesen_HUF", blank=True, null=True)
    # Field name made lowercase.
    netto_ossz = models.FloatField(db_column="Netto_ossz", blank=True, null=True)
    # Field name made lowercase.
    afa_ertek = models.BigIntegerField(db_column="AFA_ertek", blank=True, null=True)
    # Field name made lowercase.
    ...
    def save(self, *args, **kwargs):
        if self.status == "ERROR":
            log = Logs(
                ...
                status="ERROR",
                value="Hiba történt a feldolgozás során",
            )
            log.save()
...
class FolGlsElszmols(models.Model):
    # Field name made lowercase.
    csomagszam = models.BigIntegerField(db_column="Csomagszam", blank=True, null=True)
    # Field name made lowercase. Field renamed because it ended with '_'.
    ...
    # Field name made lowercase. Field renamed because it ended with '_'.
    celorszag_field = models.TextField(db_column="Celorszag_", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    futar_koltseg = models.FloatField(db_column="Futar_koltseg", blank=True, null=True)
    # Field name made lowercase. Field renamed because it ended with '_'.
...
class FolOrders(models.Model):
    ...
    # Field name made lowercase. Field renamed because it ended with '_'.
    margin_field = models.FloatField(db_column="Margin_", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    webshop_id = models.TextField(db_column="Webshop_Id", blank=True, null=True)
    # Field name made lowercase.
    order_total = models.FloatField(db_column="Order_Total", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    source_name = models.TextField(db_column="Source_Name", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    billing_email = models.TextField(db_column="Billing_Email", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    billing_city = models.TextField(db_column="Billing_City", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    shipping_email = models.TextField(db_column="Shipping_Email", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    shipping_city = models.TextField(db_column="Shipping_City", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    delivery_note = models.TextField(db_column="Delivery_Note", blank=True, null=True)
    # Field name made lowercase.
    shipping_method = models.TextField(
        db_column="Shipping_Method", blank=True, null=True
    )
    # Field name made lowercase.
    payment_method = models.TextField(db_column="Payment_Method", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    payment_status = models.TextField(db_column="Payment_Status", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    invoice_id = models.TextField(db_column="Invoice_Id", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    created_by = models.TextField(db_column="Created_by", blank=True, null=True)
    # Field name made lowercase.
    assigned_user = models.TextField(db_column="Assigned_User", blank=True, null=True)
    # Field name made lowercase.
    default_customer_class = models.TextField(
        db_column="Default_Customer_Class", blank=True, null=True
    )
    # Field name made lowercase.
    completed_date = models.DateField(db_column="Completed_Date", blank=True, null=True)
    id = models.AutoField(primary_key=True)
...
class FolSzmlk(models.Model):
    ...
    # Field name made lowercase.
    fizetes_datuma = models.TextField(db_column="Fizetes_datuma", blank=True, null=True)
    # Field name made lowercase.
    teljesites_datuma = models.TextField(
        db_column="Teljesites_datuma", blank=True, null=True
    )
    ...
    # Field name made lowercase.
    szallitmanyok = models.TextField(db_column="Szallitmanyok", blank=True, null=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    fizetesi_mod = models.TextField(db_column="Fizetesi_mod", blank=True, null=True)
    # Field name made lowercase.
    megjegyzes = models.TextField(db_column="Megjegyzes", blank=True, null=True)
    id = models.AutoField(primary_key=True)
...
class FolUnas(models.Model):
    ...
    parameter_1_m2_feluletheztext = models.TextField(
        db_column="Parameter_1_m2_feluletheztext", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
    ...
    parameter_teli_hangulat_mintatext = models.TextField(
        db_column="Parameter_Teli_hangulat_mintatext", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
    ...
    parameter_ablakfolia_tipustext = models.TextField(
        db_column="Parameter_Ablakfolia_tipustext", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
    ...
    parameter_ontapados_padlopadlotext = models.TextField(
        db_column="Parameter_Ontapados_padloPadlotext", blank=True, null=True
    )  # Field name made lowercase.
    parameter_padlo_tipusapadlotext = models.TextField(
        db_column="Parameter_Padlo_tipusaPadlotext", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
    ...
    parameter_csomag_kiszerelesenum = models.TextField(
        db_column="Parameter_Csomag_kiszerelesenum", blank=True, null=True
    )  # Field name made lowercase.
    parameter_video_segitsegvideokhtml = models.TextField(
        db_column="Parameter_Video_segitsegVideokhtml", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
    ...
    parameter_felhelyezes_nehezsegetext = models.FloatField(
        db_column="Parameter_Felhelyezes_nehezsegetext", blank=True, null=True
    )  # Field name made lowercase.
    # Field name made lowercase.
...
class ProBevtelek(models.Model):
    # Field name made lowercase.
    azonosito = models.TextField(db_column="Azonosito", blank=True, primary_key=True)
    # Field name made lowercase.
    date = models.TextField(db_column="Date", blank=True, null=True)
    # Field name made lowercase.
    teljesites_datuma = models.TextField(
...
class ProKltsgek(models.Model):
    ...
    partner = models.TextField(db_column="Partner", blank=True, null=True)
    # Field name made lowercase.
    koltsegelem = models.TextField(db_column="Koltsegelem", blank=True, null=True)
    # Field name made lowercase.
    ar = models.FloatField(db_column="Ar", blank=True, null=True)
    # Field name made lowercase.
    penznem = models.TextField(db_column="Penznem", blank=True, null=True)
    ...
    # Field name made lowercase.
    megjegyzesek = models.TextField(db_column="Megjegyzesek", blank=True, null=True)
    # Field name made lowercase.
...
class ProOrders(models.Model):
    ...
    quantity = models.FloatField(db_column="Quantity", blank=True, null=True)
    # Field name made lowercase.
    unit_price = models.TextField(db_column="Unit_Price", blank=True, null=True)
    # Field name made lowercase.
    discount = models.FloatField(db_column="Discount", blank=True, null=True)
    # Field name made lowercase.
    tax = models.FloatField(db_column="Tax", blank=True, null=True)
    ...
    webshop_id = models.TextField(db_column="Webshop_Id", blank=True, null=True)
    # Field name made lowercase.
    order_total = models.TextField(db_column="Order_Total", blank=True, null=True)
    # Field name made lowercase.
    currency = models.TextField(db_column="Currency", blank=True, null=True)
    # Field name made lowercase.
    source = models.TextField(db_column="Source", blank=True, null=True)
    ...
    order_status = models.TextField(db_column="Order_Status", blank=True, null=True)
    # Field name made lowercase.
    order_date = models.TextField(db_column="Order_Date", blank=True, null=True)
    # Field name made lowercase.
    memo = models.TextField(db_column="Memo", blank=True, null=True)
    # Field name made lowercase.
    billing_email = models.TextField(db_column="Billing_Email", blank=True, null=True)
    ...
    warehouse = models.TextField(db_column="Warehouse", blank=True, null=True)
    # Field name made lowercase.
    delivery_date = models.FloatField(db_column="Delivery_Date", blank=True, null=True)
    # Field name made lowercase.
    proforma_invoice_id = models.TextField(
        db_column="Proforma_Invoice_Id", blank=True, null=True
    )
    ...
    # Field name made lowercase.
    completed_date = models.TextField(db_column="Completed_Date", blank=True, null=True)
...
class ProStockReport(models.Model):
    ...
    sku = models.TextField(db_column="SKU", blank=True, null=True)
    # Field name made lowercase.
    on_stock = models.BigIntegerField(db_column="On_Stock", blank=True, null=True)
    # Field name made lowercase.
...
class FolStockTransactionReport(models.Model):
    ...
    operation_identifier = models.TextField(
        primary_key=True, db_column="Operation_identifier", blank=True
    )
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    cancelled_by = models.FloatField(db_column="Cancelled_by", blank=True, null=True)
    # Field name made lowercase.
    shipment_supplier_name = models.TextField(
        db_column="Shipment_supplier_name", blank=True, null=True
    )
    # Field name made lowercase.
    is_dynamic = models.TextField(db_column="Is_dynamic", blank=True, null=True)
...
class ProProducts(models.Model):
    ...
    # Field name made lowercase.
    product_class = models.FloatField(db_column="Product_Class", blank=True, null=True)
    # Field name made lowercase.
    tags = models.TextField(db_column="Tags", blank=True, null=True)
    # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
    warehouse_fo_raktar_minimum_stock_quantity = models.FloatField(
        db_column="Warehouse___Fo_raktar___Minimum_Stock_Quantity",
        blank=True,
        null=True,
    )
    # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
    warehouse_fo_raktar_optimal_stock_quantity = models.FloatField(
        db_column="Warehouse___Fo_raktar___Optimal_Stock_Quantity",
        blank=True,
        null=True,
    )
    # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
    warehouse_selejt_raktar_minimum_stock_quantity = models.FloatField(
        db_column="Warehouse___Selejt_raktar___Minimum_Stock_Quantity",
        blank=True,
        null=True,
    )
    # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
    warehouse_selejt_raktar_optimal_stock_quantity = models.FloatField(
        db_column="Warehouse___Selejt_raktar___Optimal_Stock_Quantity",
        blank=True,
        null=True,
    )
