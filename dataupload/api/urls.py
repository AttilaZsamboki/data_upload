...
urlpatterns = [
    ...
    path("fol_cf/<int:pk>/", views.FolCFDetail.as_view()),
    path("fol_orders_összesítő/", views.FolOrdersÖsszesítőList.as_view()),
    path("fol_orders_összesítő/<int:pk>/", views.FolOrdersÖsszesítőDetail.as_view()),
    ...
    path("fol_product_suppliers/<int:pk>/", views.FolProductSupplierDetail.as_view()),
    ...
    path(
        "fol_stock_transaction_report/", views.FolStockTransactionReportList.as_view()
    ),
    path(
        "fol_stock_transaction_report/<int:pk>/",
        views.FolStockTransactionReportDetail.as_view(),
    ),
    path("fol_stock_aging/", views.FolStockAgingList.as_view()),
    path("fol_stock_aging/<int:pk>/", views.FolStockAgingDetail.as_view()),
    path(
        "fol_return_order_shipping_fee/", views.FolReturnOrderShippingFeeList.as_view()
    ),
    path(
        "fol_return_order_shipping_fee/<int:pk>/",
        views.FolReturnOrderShippingFeeDetail.as_view(),
    ),
    path("fol_return_order_item/", views.FolReturnOrderItemList.as_view()),
    path("fol_return_order_item/<int:pk>/", views.FolReturnOrderItemDetail.as_view()),
    path("fol_return_order/", views.FolReturnOrderList.as_view()),
    path("fol_return_order/<int:pk>/", views.FolReturnOrderDetail.as_view()),
    path("fol_order_shipping_fee/", views.FolOrderShippingFeeList.as_view()),
    path("fol_order_shipping_fee/<int:pk>/", views.FolOrderShippingFeeDetail.as_view()),
    path("fol_order_item/", views.FolOrderItemList.as_view()),
    path("fol_order_item/<int:pk>/", views.FolOrderItemDetail.as_view()),
    path("fol_order_fee/", views.FolOrderFeeList.as_view()),
    path("fol_order_fee/<int:pk>/", views.FolOrderFeeDetail.as_view()),
    path("fol_order_etc/", views.FolOrderEtcList.as_view()),
    path("fol_order_etc/<int:pk>/", views.FolOrderEtcDetail.as_view()),
    path("fol_order_base/", views.FolOrderBaseList.as_view()),
    path("fol_order_base/<int:pk>/", views.FolOrderBaseDetail.as_view()),
    path("fol_arres_figyelo/", views.FolArresFigyeloList.as_view()),
    path("fol_arres_figyelo/<int:pk>/", views.FolArresFigyeloDetail.as_view()),
    # -------------------------------PRO-------------------------------------------#
    ...
    path("pro_product_suppliers/<int:pk>/", views.ProProductSupplierDetail.as_view()),
    ...
    path(
        "pro_return_order_shipping_fee/", views.ProReturnOrderShippingFeeList.as_view()
    ),
    path(
        "pro_return_order_shipping_fee/<int:pk>/",
        views.ProReturnOrderShippingFeeDetail.as_view(),
    ),
    path("pro_return_order_item/", views.ProReturnOrderItemList.as_view()),
    path("pro_return_order_item/<int:pk>/", views.ProReturnOrderItemDetail.as_view()),
    path("pro_return_order/", views.ProReturnOrderList.as_view()),
    path("pro_return_order/<int:pk>/", views.ProReturnOrderDetail.as_view()),
    path("pro_order_shipping_fee/", views.ProOrderShippingFeeList.as_view()),
    path("pro_order_shipping_fee/<int:pk>/", views.ProOrderItemList.as_view()),
    path("pro_order_item/<int:pk>/", views.ProOrderItemDetail.as_view()),
    path("pro_order_fee/", views.ProOrderFeeList.as_view()),
    path("pro_order_fee/<int:pk>/", views.ProOrderEtcList.as_view()),
    path("pro_order_etc/<int:pk>/", views.ProOrderEtcDetail.as_view()),
    path("pro_order_base/", views.ProOrderBaseList.as_view()),
    path("pro_order_base/<int:pk>/", views.ProOrderBaseDetail.as_view()),
    ...
    path("fol-ac-kupon/", views.FolAcKupon.as_view()),
]
